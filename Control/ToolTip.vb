...
''' Custom tooltip.
''' </summary>
<ProvideProperty("ToolTip", GetType(Object)), _
ProvideProperty("ToolTipTitle", GetType(Object)), _
ProvideProperty("ToolTipImage", GetType(Object))> _
...
#Region "Public Methods"
    ...
    Public Sub SetToolTip(ByVal obj As Object, ByVal value As String)
        ...
        If hasToolTip(obj) Then
            If TypeOf (obj) Is Windows.Forms.Control Then
                Dim ctrl As Windows.Forms.Control = DirectCast(obj, Windows.Forms.Control)
    ...
    End Sub
    <DefaultValue("")> _
    Public Function GetToolTipTitle(ByVal ctrl As Windows.Forms.Control) As String
    ...
    Public Function GetToolTipImage(ByVal ctrl As Windows.Forms.Control) As Image
    ...
    Public Function CanExtend(ByVal extendee As Object) As Boolean Implements System.ComponentModel.IExtenderProvider.CanExtend
        If TypeOf (extendee) Is Windows.Forms.Control Then
            If TypeOf (extendee) Is Windows.Forms.Form Then
                Return False
            Else
                Return True
            End If
    ...
    Private Class TooltipForm
        ...
        Sub New(ByVal popup As ToolTip, ByVal size As System.Drawing.Size)
            ...
            If mPopup._parent IsNot Nothing Then
                Dim parentForm As Form = mPopup._parent.FindForm
                If Not parentForm Is Nothing Then
                    parentForm.AddOwnedForm(Me)
                End If
            Else
                If mPopup._control IsNot Nothing Then
                    Dim parentForm As Form = mPopup._control.FindForm
                    If Not parentForm Is Nothing Then
                        parentForm.AddOwnedForm(Me)
                    End If
                End If
        ...
        Private Sub drawBackground(ByVal g As Graphics)
            If Not mPopup._ownerDrawBackground Then
                If mPopup._showShadow Then
                    ...
                    Dim pathShadow As GraphicsPath = Ai.Renderer.Drawing.roundedRectangle(rectShadow, 4, 4, 4, 4)
...
#Region "Private Methods"
    ...
    End Sub
    Private Function hasToolTip(ByVal ctrl As Windows.Forms.Control) As Boolean
    ...
    Private Sub ctrlMouseEnter(ByVal sender As Object, ByVal e As EventArgs)
        _control = DirectCast(sender, Windows.Forms.Control)
